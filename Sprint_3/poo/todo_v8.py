...
class Projeto:
    def __init__(self, nome):
        self.nome = nome
        self.tarefas = []
    # polimorfismo ajuda para percorrer o projeto
    def __iter__(self):
    ...
    def __iadd__(self, tarefa):
        ...
        return self
    # funções privadas Encapsulamento
    ...
    def add(self, tarefa, vencimento=0, **kwargs):
...
class TarefaRecorrente(Tarefa):
    ...
    def concluir(self):
        super().concluir()
        novo_vencimento = self.vencimento + timedelta(days=self.dias)
...
def main():
    ...
    mercado.add('Carne')
    mercado.add('Tomate',  datetime.now() + timedelta(days=3 , minutes=4))
    print(mercado)
